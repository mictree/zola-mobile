...
import 'package:zola/screens/recommender_follow/recommender_screen.dart';
...
import 'package:zola/widgets/stateful_bottom_bar_navigator.dart';
...
Function routerStateful = () => GoRouter(
        ...
        StatefulShellRoute.indexedStack(
          pageBuilder: (context, state, navigationShell) {
            return NoTransitionPage(
              child: ScaffoldWithStatefulNavBar(
                key: state.pageKey,
          ...
          branches: [
            StatefulShellBranch(navigatorKey: _diaryNavigatorKey, routes: [
              GoRoute(
                path: RouteConst.diary,
                parentNavigatorKey: _diaryNavigatorKey,
                pageBuilder: (context, state) {
                  return const NoTransitionPage(child: DiaryScreen());
                },
              ),
            ]),
            StatefulShellBranch(
            ...
            StatefulShellBranch(
              ...
              routes: [
                GoRoute(
                    parentNavigatorKey: _chatNavigatorKey,
